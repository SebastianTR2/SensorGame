...
public class PantallaInstrucciones implements Screen {
    ...
    @Override public void show() {
        ...
        fTitulo=new BitmapFont(); fTitulo.getData().setScale(3.2f); fTitulo.setColor(Color.RED);
        fTexto =new BitmapFont(); fTexto .getData().setScale(2.0f); fTexto .setColor(Color.WHITE);
