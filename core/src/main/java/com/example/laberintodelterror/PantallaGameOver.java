...
public class PantallaGameOver implements Screen {
    ...
    public void show() {
        ...
        //  Escala automática según resolución de pantalla
        float escalaBase = Gdx.graphics.getWidth() / 480f; // 480 es una referencia estándar
        fontTitulo.getData().setScale(2.5f * escalaBase);
        fontOpcion.getData().setScale(1.2f * escalaBase);
    }
    ...
    public void render(float delta) {
        ...
        fontOpcion.draw(batch, "1 Reintentar nivel", w / 2, h * 0.45f, 0, Align.center, false);
        fontOpcion.draw(batch, "2 Volver a selección", w / 2, h * 0.35f, 0, Align.center, false);
